defmodule Numbers do
  ...
  koan "Round the number up or down for me" do
    ...
    assert Float.round(5.5, 0) === 6.0
    assert Float.round(5.4) === 5.0
    assert Float.round(5.55, 0) === 6.0
    # ??? - Ithink this should be 5.6.
    # there is an issue open on elixir_lang to take a look at this.
    assert Float.round(5.55, 1) === 5.5
    assert Float.round(5.555, 1) === 5.6
    assert Float.round(8.95, 1) === 8.9
