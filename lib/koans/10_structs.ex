defmodule Structs do
  ...
  defmodule Plane do
    defstruct passengers: 100, maker: :boeing
  end
  ...
  koan "Use the put_in macro to replace a nested value" do
    airline = %Airline{}
    airbus = %Plane{passengers: 100, maker: :airbus}
    assert put_in(airline.plane.maker, :airbus) === %Airline{plane: airbus, name: "Southwest"}
  end
